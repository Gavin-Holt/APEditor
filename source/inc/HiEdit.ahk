...
;=======Function:	Add HE_Add(HParent, X, Y, W, H, Style="", DllPath="")
...
HE_Add(HParent, X, Y, W, H, Style="", DllPath=""){
	...
	if !MODULEID {
		ifEqual, DllPath, ,SetEnv, DllPath, APEditor.dll
...
;=======Function: AutoIndent HE_AutoIndent(hEdit, pState )
...
;=======Function: CanPaste  HE_CanPaste(hEdit,ClipboardFormat=0x1)
...
;=======Function: CanRedo HE_CanRedo(hEdit)
...
;=======Function: CanUndo HE_CanUndo(hEdit)
...
;=======Function: CloseFile HE_CloseFile(hEdit, idx=-1)
;
;	 Parameters:
...
;=======Function: CharFromPos HE_CharFromPos(hEdit,X,Y)
...
;=======Function: ConvertCase  HE_ConvertCase(hEdit, case="toggle")
...
;=======Function: EmptyUndoBuffer HE_EmptyUndoBuffer(hEdit)
...
;=======Function: FindText HE_FindText(hEdit, sText, cpMin=0, cpMax=-1, flags="")
...
;=======Function: GetColors HE_GetColors(hEdit)
;				Get the control colors.
;
;	 Returns:	Colors in INI format. See <SetColors> for details.
...
;=======Function:  GetCurrentFile HE_GetCurrentFile(hEdit)
...
;=======Function: GetFileCount HE_GetFileCount(hEdit)
...
;=======Function: GetFileName HE_GetFileName(hEdit, idx=-1)
;				Get the file path.
;
;	 Parameters:
...
;=======Function:	GetFirstVisibleLine  HE_GetFirstVisibleLine(hEdit)
...
;=======Function: GetLastVisibleLine HE_GetLastVisibleLine(hEdit)
...
;=======Function:GetLine HE_GetLine(hEdit,idx=-1)
...
;=======Function: GetLineCount HE_GetLineCount(hEdit)
...
;=======Function: GetModify HE_GetModify(hEdit, idx=-1)
...
;=======Function: GetRedoData HE_GetRedoData(hEdit, level)
...
;=======Function:  GetRect  HE_GetRect(hEdit,ByRef Left="",ByRef Top="",ByRef Right="",ByRef Bottom="")
...
;=======Function: GetSel HE_GetSel(hEdit, ByRef start_pos="@",ByRef end_pos="@")
...
;=======Function: GetSelText HE_GetSelText(hEdit)
...
;=======Function: GetTextLength HE_GetTextLength(hEdit)
...
;=======Function:	GetTextRange HE_GetTextRange(hEdit, min=0, max=-1)
...
;=======Function: GetUndoData HE_GetUndoData(hEdit, level)
...
;=======Function:	LineFromChar HE_LineFromChar(hEdit, ich)
...
;=======Function:	LineIndex HE_LineIndex(hedit, idx=-1)
...
;=======Function:	LineLength HE_LineLength(hEdit, idx=-1)
...
;=======Function: LineNumbersBar HE_LineNumbersBar( hEdit, state="show", linw=40, selw=10 )
...
;=======Function: LineScroll HE_LineScroll(hEdit,xScroll=0,yScroll=0)
...
;=======Function:	NewFile HE_NewFile(hEdit)
...
;=======Function: OpenFile HE_OpenFile(hEdit, pFileName, flag=0)
...
;=======Function: PosFromChar HE_PosFromChar(hEdit,CharIndex,ByRef X,ByRef Y)
...
;=======Function: ReloadFile HE_ReloadFile(hEdit, idx=-1)
;
;	 Parameters:
...
;=======Function: ReplaceSel HE_ReplaceSel(hEdit, text="")
...
;=======Function: SaveFile HE_SaveFile(hEdit, pFileName, idx=-1)
;
;	 Parameters:
;				pFileName	- File name.
...
;=======Function: Scroll HE_Scroll(hEdit,Pages=0,Lines=0)
...
;=======Function: ScrollCaret HE_ScrollCaret(hEdit)
...
;=======Function: SetColors HE_SetColors(hEdit, colors, fRedraw=true)
...
;=======Function: SetCurrentFile HE_SetCurrentFile(hEdit, idx)
;
;	 Parameters:
...
;=======Function: SetEvents HE_SetEvents(hEdit, Handler="", Events="selchange")
...
;=======Function: SetFont HE_SetFont(hEdit, pFont="")
...
;=======Function: SetKeywordFile HE_SetKeywordFile( pFile )
;
;	 Parameters:
;				pFile	- Path to .hes file

HE_SetKeywordFile( pFile ){
	return DllCall("APEditor.dll\SetKeywordFile", "str", pFile)
}

;=======Function: SetModify HE_SetModify(hEdit, Flag)
...
;=======Function: SetSel HE_SetSel(hEdit, nStart=0, nEnd=-1)
;
;	 Parameters:
...
;=======Function: SetTabWidth HE_SetTabWidth(hEdit, pWidth, pRedraw=true)
;
;	 Parameters:
...
;=======Function:	SetTabsImageList HE_SetTabsImageList(hEdit, pImg="")
...
;=======Function: ShowFileList HE_ShowFileList(hEdit, X=0, Y=0)
;
;	 Parameters:
...
;		o You need author's written permission to use HiEdit in commercial applications.
