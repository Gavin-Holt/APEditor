;==========Intellitype======================
;  Press 1 to 0 keys twice to autocomplete the word upon suggestion
...
Loop, Read,  %A_ScriptDir%\Autocomplete.txt   
{
...
;gmh   Input, chr, L1 V,{enter}{space};`,:¿?¡!'"()]{}{bs}{esc}
   EndKey = %errorlevel%
...
; =======Timed function to detect change of focus ==============
;=========(and remove tooltip when changing active window)======
Winchanged:
   WinGetActiveTitle, ATitle
...
;   msgbox, ErrorLevel=%ErrorLevel%   ; UNCOMMENT FOR TESTING 2ND PROBLEM DISCUSSED IN POST
   ...
   Send, %sending%  ; Then send word (Raw because we want the string exactly as in wordlist.txt)
