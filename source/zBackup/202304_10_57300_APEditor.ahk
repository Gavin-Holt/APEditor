...
;	^+A::	All occurances for multi cursor editor
	...
	^F1::	$CMDCall("")
	F5::	$CMDCall("FileMenu_Revert")
	F9::	$CMDCall("EditMenu_Find")
	F10::	$CMDCall("EditMenu_FindRE")
	F11::	$CMDCall("EditMenu_Replace")
...
; 	Menu, InsertMenu, Add,
	...
	Menu, InsertMenu, Add, Date &Stamp,MenuHandler
	Menu, InsertMenu, Add,
...
HelpMenu_Contents:
	$OpenFile(hEdit, A_ScriptDir . "\APEditor.txt")
	return
