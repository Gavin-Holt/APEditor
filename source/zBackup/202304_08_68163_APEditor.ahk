...
Gui, Add, Picture, gProjectMenu_Shell x630 y7 BackgroundTrans, img/shellbutton.png
...
;	^+A::	All occurances for multi cursor editor
	...
	^!U::	My_CMDCall("")
	^!V::	My_CMDCall("FileMenu_ViewBackup")
	^!W::	My_CMDCall("")
	^!X::	My_CMDCall("")
	^!Y::   My_CMDCall("")
	^!Z::   My_CMDCall("")
    ...
    ^!SC02B::	My_CMDCall("ProjectMenu_Shell")
...
; 	Menu, EditMenu, Add,
	...
	Menu, PreMenu, Add
	Menu, PreMenu, Add,  &Clear Prefix	Ctrl+=,MenuHandler
...
; 	Menu, InsertMenu, Add,
	...
	Menu, ProjectMenu, Add, &Shell	Ctrl+#,MenuHandler
...
EditMenu_Find:
	...
	Gui, +OwnDialogs
	InputBox, FindText, Find Text, Enter search text, , 400, 130, , , , ,%Sel%
	if ErrorLevel
		return
...
OptionsMenu_Tabs:
	InputBox, w, SetTabWidth ,Set Tab Width,,150,125,,,,,4
	if ErrorLevel
		return
...
HelpMenu_ToDo:
	My_OpenFile(hEdit, A_ScriptDir . "\ToDo.txt")
	return
